...
contract JazzEditions is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 7777;
    uint256 public maxMintPerWallet = 50;
    uint256 public mintPrice = .07 ether;
    ...
    function setMaxSupply(uint256 _maxSupply) external onlyOwner {
        require(_maxSupply < maxSupply && _maxSupply >= totalSupply(), "Supply cannot be increased");
    ...
    function withdraw() external onlyOwner {
        (bool success, ) = payable(0x06e4488Ce77Eb06aAB8BD74dA10Ce9F2454f53ed).call{
